        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                    ...
                    <li> <a class="dropdown-item"  href="index.php?view=_DiagnosticoDeNecesidades">Detectar necesidades</a></li>
           ...
           <?php ispublic();//select.php ?>
            <li class="dropdown">
                 ...
                 <?php ispublic();//select.php ?>
                      ...
                      <li><a class="dropdown-item"  href="sec/login/logout.php">Salir</a></li>
